      ...
      <div className="container mx-auto px-30 flex flex-col justify-between gap-10 ">
        {!product ? (
          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-2 p-4 rounded-lg">
              ...
              <div className="p-4 space-y-3">
                ...
                <p className="text-gray-700 my-2">
                  ...
                  adipisicing elit. Quaerat, cumque.
                </p>
                ...
                <div className="flex space-x-4 mt-4">
                  <button
                    ...
                    className="bg-blue-500 text-white px-4 py-2 rounded-lg hover:scale-105 transition-transform duration-300 cursor-pointer"
                  >
                    Add to Cart
                  </button>
            ...
            {/* Moved this section outside the product details div */}
            <div className="mt-10 space-y-10">
              <nav>
                <div className="flex justify-start gap-10 items-center text-xl font-semibold text-[#0D134E]">
                  ...
                  <button className="cursor-pointer">Additional Info</button>
