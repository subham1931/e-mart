    ...
    <div className="bg-[#E7E4F8] w-full max-w-xs mx-auto rounded-lg shadow-md overflow-hidden">
      ...
      <div className="px-5 py-5 bg-white">
        ...
        <div className="flex justify-between mt-4">
          <button className="bg-gray-200 text-black px-4 py-2 rounded-lg hover:scale-105 transition-transform duration-300">
            Add to Cart
          </button>
          <button className="bg-[#F701A8] text-white px-4 py-2 rounded-lg hover:scale-105 transition-transform duration-300">
            Wishlist
          </button>
        </div>
      </div>
